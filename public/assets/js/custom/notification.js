const applicationServerKey = "BJ8-Nr3AjrsOT-eOrMnRaD180k2G5pLo-gZQYwwhpT0ub7guDpOMoMpsGnV7hsypr-iNZnVOmudsc52utYkOaJM";
...
window.addEventListener('load', function () {
    ...
    navigator.serviceWorker.register(`//${window.location.host}/assets/js/custom/service_worker.js`)
...
function updateSubscriptionOnServer(subscription = null, subscribe = true) {
    return new Promise(function (resolve, reject) {
        let extra = (subscribe)? 'subscribe': 'unsubscribe', obj = {subscription}, pair = {type: extra};
        obj = {...obj, ...pair};
        fetch(`//${window.location.host}/subscription`, {
            method: 'POST',
            headers: {
